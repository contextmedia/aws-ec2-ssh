...
#### NOTE: the below script is based on "install.sh" in the https://github.com/contextmedia/aws-ec2-ssh/tree/master repository.
#### Check the $REPO_VERSION variable below to find the tag of the repository used

# OH Modification - script requires git to be installed...
yum install -y git
...
# OH modification - template out the groups per env, hardcoded in script and not taken as args
IAM_GROUPS="${environment}-jump-box"
SUDO_GROUPS="${environment}-jump-box-sudoers"
LOCAL_GROUPS=""
ASSUME_ROLE=""
USERADD_PROGRAM=""
USERADD_ARGS=""

# OH modification - pin the repo version
